...
there is no toggle yet (authenticated screens follow `prefers-color-scheme`). The public
MediGuard landing page intentionally remains light so its brand palette is stable. See the
[MediGuard visual system](../docs/frontend.md#mediguard-visual-system) for the canonical colours.
