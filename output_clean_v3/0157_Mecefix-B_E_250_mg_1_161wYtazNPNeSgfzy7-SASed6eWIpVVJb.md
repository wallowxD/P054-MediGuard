...
**MECEFIX-B.E 100 mg:** Mỗi viên nang cứng chứa 100 mg cefixime (dưới dạng cefixime trihydrate)
**MECEFIX-B.E 150 mg:** Mỗi viên nang cứng chứa 150 mg cefixime (dưới dạng cefixime trihydrate)
**MECEFIX-B.E 200 mg:** Mỗi viên nang cứng chứa 200 mg cefixime (dưới dạng cefixime trihydrate)
**MECEFIX-B.E 250 mg:** Mỗi viên nang cứng chứa 250 mg cefixime (dưới dạng cefixime trihydrate)
**MECEFIX-B.E 400 mg:** Mỗi viên nang cứng chứa 400 mg cefixime (dưới dạng cefixime trihydrate)
...
| Từ dưới 20 hoặc thẩm phân phúc mạc liên tục | 172 |
...
Tiêu chảy do *Clostridium difficile* (CDAD) đã được báo cáo với hầu hết các kháng sinh, bao gồm cả cefixime, với mức độ nghiêm trọng từ tiêu chảy nhẹ đến viêm đại tràng gây tử vong. Việc điều trị bằng các kháng sinh làm thay đổi hệ vi khuẩn bình thường ở đại tràng, dẫn đến phát triển sự quá mức của *C.difficile*. *C.difficile* sinh độc tố A và B, góp phần phát triển CDAD. Các chủng sinh độc tố cao của *C.difficile* làm gia tăng bệnh tật và tử vong vì các chủng này có thể kháng kháng sinh và có thể cần phẫu thuật cắt bỏ kết tràng. CDAD phải được xem xét ở tất cả các bệnh nhân có tiêu chảy sau khi sử dụng kháng sinh. Đánh giá cẩn thận bệnh sử là cần thiết bởi CDAD đã được báo cáo xảy ra sau hơn hai tháng sử dụng kháng sinh
...
**Phụ nữ có thai**
Các nghiên cứu sinh sản đã được thực hiện trên chuột ở liều cao gấp 40 lần so với liều dùng ở người, kết quả cho thấy không có bằng chứng cefixime gây hại đến bào thai chuột. Không có dữ liệu về sử dụng thuốc trên phụ nữ có thai, chỉ nên dùng thuốc nếu lợi ích vượt trội so với nguy cơ
**Phụ nữ cho con bú**
...
Chưa có bằng chứng về ảnh hưởng của thuốc đến khả năng lái xe, vận hành máy móc. Tuy nhiên, các tác dụng không mong muốn đã được báo cáo của cefixime như nhức đầu, chóng mặt có thể ảnh hưởng đến khả năng lái xe và vận hành máy móc
...
*Thận:* Suy thận cấp bao gồm viêm thận mô kẽ là tình trạng bệnh lý cơ bản
...
Nhóm dược lý trị liệu: Kháng sinh cephalosporin thế hệ 3
Mã ATC: J01DD08
**Cơ chế tác dụng**
...
Hộp 1 lọ 100 viên nang cứng
Hộp 1 lọ 200 viên nang cứng
**BẢO QUẢN**
Bảo quản trong bao bì kín, nơi khô, dưới 30 °C, tránh ánh sáng trực tiếp
**TIÊU CHUẨN:** Tiêu chuẩn cơ sở
**HẠN SỬ DỤNG:** 42 tháng kể từ ngày sản xuất

Sản xuất bởi MERAP GROUP
**CÔNG TY CỔ PHẦN TẬP ĐOÀN MERAP**
Bá Khê, Tân Tiến, Văn Giang, Hưng Yên,
