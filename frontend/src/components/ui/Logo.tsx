 ...
 *   và đặt tại `public/images/vinmec/logo-vinmec-system.png`.
 *
 * ★ Vì logo ĐÃ chứa sẵn chữ "VINMEC", nơi gọi KHÔNG đặt thêm <span> tên thương hiệu
 *   bên cạnh nữa — làm vậy là hiện tên hai lần.
 *
 * ★ Logo nằm ngang (tỉ lệ 456×282), không phải hình vuông như mark cũ. Nơi gọi phải
...
export default function Logo({
  ...
  return (
    <Image
      ...
      height={282}
      priority
      className={`vinmec-brand-logo object-contain ${className}`}
    />
  );
}
