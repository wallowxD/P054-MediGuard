      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 sm:py-16">
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-5">
          ...
          <div className="space-y-4 lg:col-span-2">
            ...
            <p className="max-w-sm text-xs leading-relaxed text-foreground-secondary">
              Hệ thống Y tế phi lợi nhuận do Tập đoàn Vingroup đầu tư phát triển với sứ mệnh
              mang lại sự lựa chọn hoàn hảo về chăm sóc sức khỏe cho người bệnh.
            </p>
            <div className="flex items-center gap-3 pt-2">
              <span className="text-xs text-foreground-muted">Ứng dụng MyVinmec:</span>
              <div className="flex items-center gap-2">
                <Image
                  ...
                  width={64}
                  height={64}
                  className="h-12 w-12 rounded-xl liquid-glass-subtle p-1"
                />
              </div>
            </div>
          </div>
        ...
        {medicalDisclaimer ? (
          <div className="mt-8 rounded-2xl liquid-glass-subtle p-4 text-xs leading-relaxed text-foreground-muted">
            ...
            <p>
              Các cảnh báo tương tác thuốc và thông tin tra cứu trên hệ thống mang tính tham khảo y tế,
              không thay thế chỉ định trực tiếp từ bác sĩ chuyên khoa hoặc dược sĩ lâm sàng.
            </p>
          </div>
        ) : null}
