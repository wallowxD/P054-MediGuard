...
Mỗi mL có chứa 100 đơn vị insulin glargine* (tương đương với 3,64 mg). Mỗi bút tiêm có chứa 3 mL dung dịch tiêm, tương đương với 300 đơn vị.

\* Insulin glargine được sản xuất bằng công nghệ tái tổ hợp DNA trên *Escherichia coli*.

<u>*Thành phần tá dược:*</u>
- Kẽm oxid
- Metacresol
- Glycerol
- Acid hydrochloric (để điều chỉnh pH)
...
### 4. CHỈ ĐỊNH, LIỀU DÙNG VÀ CÁCH DÙNG, CHỐNG CHỈ ĐỊNH
...
Phác đồ điều trị BASAGLAR (liều và thời gian) nên được điều chỉnh theo từng bệnh nhân. Ở bệnh nhân đái tháo đường typ 2, BASAGLAR cũng có thể được dùng cùng với các thuốc trị đái

BASAGLAR nên giảm khoảng 20% liều insulin đang dùng.
...
Khuyến cáo theo dõi chặt chẽ chuyển hóa trong suốt quá trình chuyển đổi và trong những tuần đầu sau đó. Với việc kiểm soát chuyển hóa được cải thiện và kết quả là tăng mức độ nhạy insulin, có thể cần điều chỉnh thêm chế độ liều. Cũng có thể cần phải điều chỉnh liều, ví dụ như bệnh nhân thay đổi cân nặng hoặc phong cách sống, thay đổi thời gian dùng insulin hoặc các tình huống khác xảy ra gây tăng nguy cơ hạ đường huyết hoặc tăng đường huyết (xem phần 5.1).
...
Để biết chi tiết hơn về thao tác, xem phần 5.4.

Trước khi sử dụng dung dịch tiêm BASAGLAR trong bút tiêm đóng sẵn thuốc, bạn phải đọc kỹ hướng dẫn sử dụng bút tiêm đi kèm trong tờ hướng dẫn sử dụng thuốc (xem phần 5.4).

### 4.3. Chống chỉ định

Mẫn cảm với hoạt chất hoặc bất kỳ thành phần tá dược nào được liệt kê trong mục 2.

### 5. CẢNH BÁO VÀ THẬN TRỌNG

#### 5.1. Cảnh báo đặc biệt và thận trọng khi sử dụng
...
Khi chuyển bệnh nhân sang sử dụng một loại insulin khác hay nhãn hiệu insulin khác, cần thực

hiện dưới sự giám sát y tế chặt chẽ. Những thay đổi về nồng độ, nhãn hiệu (nhà sản xuất), loại (tác dụng ngắn, NPH, chậm, tác dụng kéo dài v.v...), nguồn gốc (insulin động vật, insulin người, chất tương tự insulin người), và/hoặc phương pháp sản xuất có thể dẫn đến việc cần phải thay đổi liều dùng.
...
- bị bệnh tâm thần,
- được điều trị đồng thời với một số loại thuốc khác (xem phần 6).

Những trường hợp như thế có thể dẫn đến tình trạng hạ đường huyết nặng (và có thể mất trí giác) trước khi bệnh nhân nhận biết được tình trạng hạ đường huyết.
...
Bệnh gian phát đòi hỏi sự tăng cường kiểm soát chuyển hoá. Trong nhiều trường hợp, các xét nghiệm nước tiểu tìm ceton được chỉ định, và thường thì cần phải điều chỉnh liều insulin. Nhu cầu insulin thường gia tăng. Bệnh nhân đái tháo đường typ 1 phải tiếp tục ăn đều đặn ít nhất một lượng nhỏ carbohydrate, ngay cả khi họ chỉ có thể ăn ít hoặc không có thức ăn, hoặc nôn mửa v.v... và không bao giờ được ngừng dùng insulin hoàn toàn.

<u>Kháng thể kháng insulin</u>

Dùng insulin có thể gây ra sự hình thành các kháng thể kháng insulin. Trong một số ít trường hợp, sự hiện diện của các kháng thể kháng insulin như vậy có thể cần điều chỉnh liều insulin để điều chỉnh xu hướng tăng hoặc hạ đường huyết (xem phần 5.1).
...
<u>Phối hợp BASAGLAR với pioglitazone</u>
...
**5.2. Khả năng sinh sản, mang thai và cho con bú**

<u>Mang thai</u>

Không có dữ liệu lâm sàng với insulin glargine về phụ nữ mang thai dùng thuốc từ các nghiên cứu lâm sàng có đối chứng. Một số lượng lớn dữ liệu về phụ nữ mang thai (hơn 1000 kết quả trên phụ nữ mang thai) cho thấy không có tác dụng bất lợi cụ thể nào của insulin glargine trên

phụ nữ mang thai và không có độc tính đặc hiệu gây dị tật cho thai nhi/trẻ sơ sinh do dùng insulin glargine.
...
**5.3. Tác động lên khả năng lái xe và vận hành máy móc**
...
**5.4. Thận trọng đặc biệt trong tiêu hủy và các thao tác khác**
...
Basaglar_PFP_Eu SmPC 13 Jan 2020_VN_Feb 2020_Proposed truth_PI_V03

Luôn luôn kiểm tra nhãn insulin trước mỗi lần tiêm để tránh dùng nhầm insulin glargine với các insulin khác (xem phần 5.1).
...
Các chất có thể làm tăng tác dụng hạ đường huyết và tăng nhạy cảm với hạ đường huyết bao gồm các thuốc điều trị đái tháo đường dạng uống, các thuốc ức chế enzym chuyển angiotensin (ACE), disopyramid, các fibrate, fluoxetine, các chất ức chế monoamin oxidase (MAO), pentoxifylline, propoxyphen, các salicylat, các chất tương tự somatostatin và các thuốc kháng sinh sulfonamide.

Các chất làm giảm tác dụng hạ đường huyết bao gồm corticosteroid, danazol, diazoxide, các thuốc lợi tiểu, glucagon, isoniazid, estrogen, progestogen, dẫn xuất phenothiazin, somatropin, các thuốc giống giao cảm (ví dụ epinephrine [adrenaline], salbutamol, terbutaline), hormon tuyến giáp, các thuốc chống loạn thần không điển hình (ví dụ clozapine và olanzapine) và thuốc ức chế protease.
...
Hạ đường huyết (rất phổ biến), nhìn chung là tác dụng không mong muốn thường gặp nhất khi điều trị insulin, có thể xảy ra nếu liều insulin quá cao vượt quá nhu cầu (xem phần 5.1).

<u>Bảng các tác dụng không mong muốn</u>
...
Trong mỗi nhóm tỷ lệ mắc, các tác dụng không mong muốn được thể hiện trong thứ tự giảm dần

về mức độ nghiêm trọng.

| Phân loại hệ cơ quan theo MedDRA | Rất phổ biến | Phổ biến | Không phổ biến | Hiếm | Rất hiếm | Không rõ |
| --- | --- | --- | --- | --- | --- | --- |
...
<u>Mô tả về các tác dụng không mong muốn chọn lọc</u>

*Rối loạn chuyển hóa và dinh dưỡng*

Các cơn hạ đường huyết nặng, đặc biệt nếu tái phát, có thể dẫn đến tổn thương thần kinh. Các cơn hạ đường huyết kéo dài hoặc nghiêm trọng có thể đe dọa đến tính mạng. Ở nhiều bệnh nhân, các dấu hiệu và triệu chứng của biểu hiện suy nhược thần kinh do thiếu glucose não được báo trước bởi các dấu hiệu của sự đáp ứng điều hòa ngược của adrenergic. Nhìn chung, sự suy giảm đường huyết càng nhiều và càng nhanh thì hiện tượng đáp ứng điều hòa ngược và các triệu chứng của nó càng rõ rệt.

*Rối loạn hệ miễn dịch*

Các phản ứng dị ứng với insulin kiểu ngay lập tức rất hiếm. Những phản ứng như vậy với insulin (kể cả insulin glargine) hoặc tá dược, có thể đi kèm với phản ứng lan rộng ngoài da, phù mạch, co thắt phế quản, tụt huyết áp và sốc, và có thể đe dọa đến tính mạng.
...
<u>Báo cáo về các tác dụng không mong muốn bị nghi ngờ</u>
...
Insulin glargine được chuyển hóa thành 2 chất chuyển hóa có hoạt tính M1 và M2 (xem phần 9.2).

<u>Khả năng gắn kết với thụ thể insulin</u>
...
<u>Các tác động dược lực học</u>

Hoạt tính chính của insulin, gồm cả insulin glargine, là sự điều hòa chuyển hóa glucose. Insulin và các chất tương tự của nó làm hạ nồng độ glucose trong máu bằng cách kích thích sự thu nạp glucose ở ngoại biên, đặc biệt là ở cơ vân và mỡ mô, và bằng cách ức chế sự sản sinh glucose ở gan. Insulin ức chế sự giải lipid trong tế bào mỡ, ức chế tiêu protein và tăng tổng hợp protein. .
...
Trong các nghiên cứu kẹp giữ nồng độ glucose máu ở những người tình nguyện khỏe mạnh hoặc ở những bệnh nhân đái tháo đường typ 1, sự khởi phát tác dụng của insulin glargine dưới da chậm hơn so với insulin người NPH, tác động của thuốc trơn tru và không đỉnh, và thời gian tác dụng kéo dài.

Hình dưới đây cho thấy kết quả từ một nghiên cứu trên bệnh nhân:

**Hình 1: Dữ liệu hoạt tính ở bệnh nhân đái tháo đường typ 1**

Tỷ lệ tiêu thụ glucose* (mg/kg/phút)

insulin glargine
NPH insulin

Thời gian (giờ) sau khi tiêm

Kết thúc thời gian giám sát

\* Được xác định bằng lượng glucose được truyền để duy trì nồng độ glucose hằng định trong máu (giá trị trung bình theo giờ).

Thời gian tác dụng dài hơn của insulin glargine dưới da liên quan trực tiếp đến tốc độ hấp thụ chậm hơn và hỗ trợ cho việc dùng một lần mỗi ngày. Thời gian tác dụng của insulin và các chất tương tự insulin như insulin glargine có thể biến thiên đáng kể giữa những cá thể khác nhau hoặc trên cùng một cá thể.
...
Các kết quả dược động học và dược lực học cho thấy tác dụng của tiêm dưới da insulin glargine chủ yếu dựa vào nồng độ M1. Insulin glargine và chất chuyển hóa M2 không thể phát hiện được ở đa số người dùng và, khi phát hiện được các chất này thì nồng độ của chúng không phụ thuộc

vào liều insulin glargine được dùng.

<u>Thải trừ</u>

Khi tiêm tĩnh mạch, thời gian bán thải của insulin glargine và insulin người là tương đương nhau.

<u>Nhóm dân số đặc biệt</u>

Trong các nghiên cứu lâm sàng, các phân tích nhóm tuổi tác và giới tính không cho thấy sự khác biệt về tính an toàn và hiệu quả giữa những bệnh nhân được điều trị bằng insulin glargine so với nhóm bệnh nhân còn lại của nghiên cứu.

<u>Nhóm bệnh nhân nhi</u>

Dược động học ở trẻ từ 2 đến dưới 6 tuổi mắc đái tháo đường týp 1 được đánh giá trong một nghiên cứu lâm sàng (xem phần 9.1). Nồng độ đáy insulin glargine trong huyết tương và các chất chuyển hóa chính M1 và M2 đo được ở trẻ được điều trị bằng insulin glargine, cho thấy nồng độ huyết tương tương tự như người lớn và không có bằng chứng cho thấy có sự tích tụ insulin glargine hoặc các chất chuyển hóa của nó khi dùng lâu dài.
...
Mỗi bút tiêm đóng sẵn thuốc chứa 3 ml dung dịch thuốc tiêm.

Hộp chứa 5 bút tiêm đóng sẵn thuốc.

Hộp thuốc không chứa kim tiêm.

**11. ĐIỀU KIỆN BẢO QUẢN, HẠN DÙNG VÀ TIÊU CHUẨN CHẤT LƯỢNG**
...
**11.3 Tiêu chuẩn chất lượng**

Tiêu chuẩn cơ sở.

**12. TÊN VÀ ĐỊA CHỈ NHÀ SẢN XUẤT**

**Sản xuất và đóng gói bởi:**

Lilly France, 2 rue du colonel Lilly, 67640 Fegersheim, Pháp.

**Hướng dẫn sử dụng bút tiêm KwikPen**

**Bút tiêm đóng sẵn dung dịch tiêm BASAGLAR™ 100 đơn vị/mL**

**Insulin glargine**

**VUI LÒNG ĐỌC KỸ TỜ HƯỚNG DẪN NÀY TRƯỚC KHI SỬ DỤNG**

Đọc tờ Hướng dẫn sử dụng này trước khi sử dụng BASAGLAR và mỗi lần sử dụng bút tiêm BASAGLAR KwikPen. Có thể có thêm những thông tin mới. Những thông tin dưới đây không thể thay thế được việc trao đổi với bác sỹ của bạn về tình trạng sức khỏe hoặc trị liệu của bạn.

BASAGLAR KwikPen ("Bút tiêm") là bút tiêm đóng sẵn thuốc chứa 300 đơn vị (3 mL) Insulin glargine. Một bút có thể tiêm được nhiều liều. Bút quay mỗi lần 1 đơn vị thuốc. Bạn có thể tiêm được từ 1 đến 80 đơn vị cho mỗi mũi tiêm. Nếu liều của bạn là hơn 80 đơn vị, bạn sẽ cần phải tiêm nhiều hơn một mũi tiêm. Pít tông chỉ di chuyển một chút mỗi lần tiêm và bạn không cảm nhận được sự di chuyển đó. Pít tông sẽ chỉ chạm đến tận cùng của ống thuốc khi bạn đã sử dụng hết 300 đơn vị trong bút.
...
Không khuyến cáo người mù hoặc có thị lực kém sử dụng bút tiêm này mà không có sự hỗ trợ của người đã được học cách sử dụng bút.
...
### Các phần của kim bút tiêm
**(Kim tiêm không đi kèm với bút)**
...
**Núm chỉnh liều với vòng tròn xanh lá cây**

**Cách nhận biết bút tiêm BASAGLAR KwikPen của bạn:**
- Màu của bút: Xám nhạt
- Núm chỉnh liều: Xám nhạt và có vòng tròn xanh lá cây ở cuối
- Nhãn: Xám nhạt với dải màu xanh lá cây

**Những dụng cụ cần cho việc tiêm của bạn:**
- Bút tiêm BASAGLAR KwikPen
...
- Không sử dụng bút tiêm đã quá hạn sử dụng in trên nhãn hoặc sau 28 ngày kể từ ngày bắt đầu sử dụng bút.
- Luôn luôn sử dụng một kim tiêm mới cho mỗi lần tiêm nhằm phòng ngừa nhiễm khuẩn và kim bị nghẹt

| | |
| --- | --- |
| **Bước 1:**<br>• Rút thẳng nắp bút ra.<br>- Không gỡ bỏ nhãn bút.<br>• Sử dụng miếng gạc để lau miếng nối kín bằng cao su.<br><br>Dung dịch thuốc BASAGLAR cần phải trong và không màu. Không dùng nếu thấy thuốc bị đục, có màu hoặc có các vật thể lạ hoặc vón cục bên trong. | |
| **Bước 2:**<br>• Chọn một kim tiêm mới.<br>• Bỏ nắp giấy bảo vệ kim bên ngoài. | |
| **Bước 3:**<br>• Ấn kim vẫn còn ở trong nắp thẳng vào bút và vặn kim cho đến khi thấy đã chặt. | |

| | |
| --- | --- |
| **Bước 4:**<br>• Tháo nắp bảo vệ kim bên ngoài. Đừng bỏ nắp bảo vệ đó đi.<br>• Tháo nắp bảo vệ kim bên trong và bỏ đi. | Giữ lại Bỏ đi |
...
| | |
| --- | --- |
| **Bước 5:**<br>• Để chuẩn bút tiêm, vặn núm chỉnh liều để chọn 2 đơn vị. | |
| **Bước 6:**<br>• Cầm bút (có gắn kim) thẳng đứng. Gõ vào phần thân giữ ống thuốc để các bóng khí trong ống tập hợp lại và di chuyển lên phía trên. | |
| **Bước 7:**<br>• Vẫn giữ bút (có kim) thẳng đứng. Nhấn vào núm chỉnh liều cho đến khi nó dừng lại và màn hình hiển thị liều xuất hiện số "0". Giữ núm chỉnh liều và đếm chậm đến 5.<br><br>Bạn sẽ nhìn thấy có insulin xuất hiện ở đầu kim tiêm.<br>- Nếu bạn không nhìn thấy insulin, lặp lại bước chuẩn bút, nhưng không làm quá 4 lần.<br>- Nếu bạn vẫn không nhìn thấy insulin, đổi kim và lặp lại các bước chuẩn bút.<br><br>Thấy có bọt khí nhỏ là bình thường và sẽ không ảnh hưởng đến liều thuốc của bạn. | |

### Chọn liều

* Bạn có thể tiêm được từ 1 đến 80 đơn vị mỗi lần tiêm.
* Nếu liều của bạn lớn hơn 80 đơn vị, bạn cần tiêm nhiều hơn một mũi tiêm.
...
* Xoay núm chỉnh liều đến số đơn vị bạn cần tiêm. Vạch chỉ liều cần chỉ đúng liều của bạn.
  ...
  - Liều có thể chỉnh bằng cách xoay núm chỉnh liều theo hướng tới hoặc lui cho đến khi vạch chỉ liều chỉ đúng liều bạn cần tiêm.
  - Các số chẵn được in trên vòng tròn quay.

*(Ví dụ: 12 đơn vị thể hiện ở Màn hình hiển thị liều)*

  - Các số lẻ, sau số 1, được hiển thị bằng những đường kẻ dài.

*(Ví dụ: 25 đơn vị thể hiện ở Màn hình hiển thị liều)*
...
* Nếu bạn cần tiêm nhiều hơn số lượng đơn vị còn lại trong bút, bạn có thể chọn một trong hai cách:
  - Tiêm số lượng còn lại trong bút và sau đó dùng một bút mới để tiêm nốt phần liều còn lại,
    hoặc
...
* Tiêm Insulin theo cách cán bộ y tế đã hướng dẫn bạn.
...
* BASAGLAR được tiêm dưới da vùng bụng, mông, đùi hoặc cánh tay trên.
* Sát khuẩn da theo hướng dẫn của cán bộ y tế.
...
Đừng cố tiêm bằng cách xoay núm chỉnh liều. Bạn sẽ KHÔNG nhận được Insulin bằng cách đó.

**Bước 11:**

* **Rút kim ra khỏi da.**
  * Một giọt Insulin nhỏ ra ở đầu mũi kim là bình thường. Điều này sẽ không ảnh hưởng gì đến liều của bạn.
...
Pít tông chỉ chuyển dịch một chút sau mỗi lần tiêm, và bạn có thể không nhận thấy sự di chuyển này.

Nếu bạn nhìn thấy máu sau khi rút kim ra khỏi da, ấn nhẹ một miếng gạc hoặc một miếng bông vào chỗ tiêm. Không chà xát khu vực đó.

### Sau khi tiêm

| |
| --- |
| **Bước 12:**<br>Cẩn thận đậy nắp bảo vệ ngoài của kim. |
| **Bước 13:**<br>• Tháo kim có nắp ra và vứt bỏ nó theo hướng dẫn của cán bộ y tế.<br>• Không bảo quản bút khi còn gắn kim trên đó để phòng tránh rò rỉ, tắc kim, và không khí xâm nhập vào bút. |
| **Bước 14:**<br>• Đậy nắp bút sao cho hướng của thanh gài trên nắp bút thẳng hàng với màn hình hiển thị liều. |

**Tiêu hủy bút và kim**

* Bỏ kim đã sử dụng vào thùng đựng đồ sắc nhọn hoặc hộp nhựa cứng có nắp an toàn.
* Không tái sử dụng các hộp đựng đồ sắc nhọn đã đầy.
* Hỏi ý kiến cán bộ y tế về các cách thải bỏ các hộp đựng đồ sắc nhọn một cách an toàn.
* Những hướng dẫn liên quan đến xử lý kim tiêm này không thay thế cho các nguyên tắc, quy định của địa phương, của các cán bộ y tế và của hệ thống y tế.
...
* Không làm đông lạnh BASAGLAR. Không sử dụng nếu bút đã bị đông lạnh.
* Bút chưa sử dụng có thể sử dụng đến ngày hết hạn in trên nhãn, nếu bút tiêm đó được bảo quản trong tủ lạnh.

**Bút đã sử dụng**

* Bảo quản bút tiêm mà bạn đang sử dụng ở nhiệt độ phòng đến tối đa 30°C và tránh nóng ánh sáng.
* Bỏ bút tiêm sau khi bạn đã sử dụng 28 ngày, kể cả khi vẫn còn thuốc trong đó.
...
* Nếu núm chỉnh liều khó ấn xuống:
  - Hãy ấn núm chỉnh liều chậm hơn nhằm giúp dễ tiêm hơn.
  - Có thể kim tiêm của bạn bị nghẹt. Hãy dùng kim tiêm mới và chuẩn bút.
  - Bạn có thể thấy bụi bẩn, thức ăn hoặc chất lỏng bên trong bút. Hãy bỏ bút đó đi và dùng một bút mới.

Nếu bạn có bất kỳ câu hỏi hay có vấn đề gì với BASAGLAR KwikPen của bạn, hãy liên hệ các cán bộ y tế để được trợ giúp.
...
**Bước 4:**
* Tháo nắp bảo vệ kim bên ngoài. Đừng bỏ nắp bảo vệ đó đi.
...
**Bước 6:**
* Cầm bút (có gắn kim) thẳng đứng. Gõ vào phần thân giữ ống thuốc để các bóng khí trong ống tập hợp lại và di chuyển lên phía trên.

**Bước 7:**
* Vẫn giữ bút (có kim) thẳng đứng. Nhấn vào núm chỉnh liều cho đến khi nó dừng lại và màn hình hiển thị liều xuất hiện số "0". Giữ núm chỉnh liều và đếm chậm đến 5.

Bạn sẽ nhìn thấy có insulin xuất hiện ở đầu kim tiêm.
- Nếu bạn không nhìn thấy insulin, lặp lại bước chuẩn bút, nhưng không làm quá 4 lần.
- Nếu bạn vẫn không nhìn thấy insulin, đổi kim và lập lại các bước chuẩn bút.
...
| **Bước 8:**<br>• Xoay núm chỉnh liều đến số đơn vị bạn cần tiêm. Vạch chỉ liều cần chỉ đúng liều của bạn.<br> - Bút tiêm có thể quay 1 đơn vị mỗi lần.<br> - Núm chỉnh liều sẽ kêu click khi bạn xoay nó.<br> - KHÔNG quay số liều của bạn bằng cách đếm các tiếng kêu click vì bạn có thể quay sai liều.<br> - Liều có thể chỉnh bằng cách xoay núm chỉnh liều theo hướng tới hoặc lùi cho đến khi vạch chỉ liều chỉ đúng liều bạn cần tiêm.<br> - Các số chẵn được in trên vòng tròn quay.<br> - Các số lẻ, sau số 1, được hiển thị bằng những đường kẻ dài.<br>• **Luôn luôn kiểm tra chỉ số ở Màn hình hiển thị liều để chắc chắn là bạn đã quay đến đúng liều.** | (Ví dụ: 12 đơn vị thể hiện ở Màn hình hiển thị liều)<br><br>(Ví dụ: 25 đơn vị thể hiện ở Màn hình hiển thị liều) |
...
| | |
| --- | --- |
| **Bước 9:**<br>**Chọn vị trí tiêm.**<br>• BASAGLAR được tiêm dưới da vùng bụng, mông, đùi hoặc cánh tay trên.<br>• Sát khuẩn da theo hướng dẫn của cán bộ y tế. | |
| **Bước 10:**<br>• Chọc kim vào da.<br>• Nhấn dứt khoát núm chỉnh liều vào sâu.<br>• Tiếp tục giữ núm chỉnh liều tại chỗ và đếm chậm đến 5 trước khi rút kim ra khỏi da.<br><br>Đừng cố tiêm bằng cách xoay núm chỉnh liều. Bạn sẽ KHÔNG nhận được insulin bằng cách đó. | |
