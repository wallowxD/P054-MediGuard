...
class PageOCRResult(BaseModel):
    ...
    error: Optional[str] = Field(default=None, description="Error message if page OCR failed")
...
class OCRProcessRequest(BaseModel):
    ...
    dpi: Optional[int] = Field(default=None, description="Custom DPI for rendering (defaults to settings)")
